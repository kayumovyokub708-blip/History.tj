  ...
  if (!item) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-20 text-center">
        <Link to="/encyclopedia/dynasties" className="text-primary">← Dynasties</Link>
      </div>
    )
  }
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <Link to="/encyclopedia/dynasties" className="text-sm text-primary hover:underline">← Dynasties</Link>
      ...
      <div className="flex gap-2 mt-3">
        ...
        {item.capital && <Badge variant="outline">Capital: {item.capital}</Badge>}
      </div>
      <Card className="mt-8">
